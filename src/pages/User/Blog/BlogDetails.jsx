        ...
        <div className="w-full h-full px-0 md:px-32 py-0 md:py-10">
          ...
          <div className="w-full p-5 flex flex-col gap-4">
            ...
            <div
              ...
              className="text-sm overflow-hidden break-words leading-7"
            ></div>
          </div>
                ...
                allComments.map((oneComment) => (
                  <div className="w-full h-14 shadow-md bg-gray-300 p-2">
                    <div className="flex gap-2 h-2/6">
                      ...
                      <TimeAgo
                        className="flex items-center text-veryVerySmall"
                        date={oneComment?.createdAt}
                      />
                    </div>
                    <div className=" h-4/6 flex items-center font-normal text-verySmall-1">
                      {oneComment?.content}
                    </div>
                  </div>
                ))}
